        ...
        <div className="nav-links">
          ...
          <div className="nav-item nav-dropdown nav-resources-dropdown" role="button" aria-haspopup="true" aria-expanded="false" aria-label="Menú de recursos">
            ...
            <div className="nav-dropdown-menu" role="menu">
              <Link to="/introduccion" className="nav-dropdown-link" role="menuitem">Introduccion</Link>
              <Link to="/sobre-nosotros" className="nav-dropdown-link" role="menuitem">Sobre nosotros</Link>
            </div>
          </div>
        </div>
      )}
